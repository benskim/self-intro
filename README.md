...
*   **SPA 디자인 시스템**: 톤앤매너(`spartaRed`)를 유지한 일관성 있는 컴포넌트 설계
*   **배지 기반 네비게이션**: `Slide 1, 2`와 같은 인위적인 요소를 제거하고, 콘텐츠의 속성(`[Problem Definition]`, `[EDA]`, `(로그 인프라 설계)` 등)을 직관적인 텍스트 배지로 시각화
*   **반응형 탭 시스템**: 각 프로젝트 간 전환이 매끄러운 탭 레이아웃 구현
